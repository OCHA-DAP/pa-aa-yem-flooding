...
This doc is purely exploratory
...
we see that lat lon are missing... 

year looks good, month looks descent s
no deaths not terrible 
river basin has 0 completion
```{r}
skimr::skim(emdat)
```

let's skim desvinttar dta
```{r}
desinv %>% 
    skimr::skim()
