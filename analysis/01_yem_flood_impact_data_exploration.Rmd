...
# 13 sites in floodlist that do not have coordinates
cccm_floodlist%>% 
...
```{r}
cccm_floodlist_w_coords %>% glimpse()
cccm_floodlist_w_coords %>% 
    glimpse()
...
p_shelters_affected_site <- site_level_stats %>% 
    ...
    geom_col()+
    labs(y= "# Shelters Affected by flooding",
...
p_ratio <- site_level_stats %>% 
    ...
    labs(x= "Number Shelters Affected", 
