...
list(
  ...
  tar_target(
    ...
    command = chirps_daily_to_sites(
      raster_dir = chirps_dir,
  ...
  tar_target(
    name = p_timeseries_rainfall,
    command = plot_rainfall_impact_timeseries(
      site_rainfall = cccm_site_chirp_stats,
